...
export type LauchListQueryVariables = Exact<{ [key: string]: never; }>;


export type LauchListQuery = (
  { __typename?: 'Query' }
...
export type LauchProfileQueryVariables = Exact<{
  id?: Maybe<Scalars['String']>;
}>;


export type LauchProfileQuery = (
  { __typename?: 'Query' }
  & { launch?: Maybe<(
    { __typename?: 'Launch' }
...
export const LauchListDocument = gql`
    query LauchList {
  launches {
    flight_number
    mission_name
...
/**
 * __useLauchListQuery__
 *
 * To run a query within a React component, call `useLauchListQuery` and pass it any options that fit your needs.
 * When your component renders, `useLauchListQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useLauchListQuery({
 *   variables: {
 *   },
 * });
 */
export function useLauchListQuery(baseOptions?: Apollo.QueryHookOptions<LauchListQuery, LauchListQueryVariables>) {
        return Apollo.useQuery<LauchListQuery, LauchListQueryVariables>(LauchListDocument, baseOptions);
      }
export function useLauchListLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<LauchListQuery, LauchListQueryVariables>) {
          return Apollo.useLazyQuery<LauchListQuery, LauchListQueryVariables>(LauchListDocument, baseOptions);
        }
export type LauchListQueryHookResult = ReturnType<typeof useLauchListQuery>;
export type LauchListLazyQueryHookResult = ReturnType<typeof useLauchListLazyQuery>;
export type LauchListQueryResult = Apollo.QueryResult<LauchListQuery, LauchListQueryVariables>;
export const LauchProfileDocument = gql`
    query LauchProfile($id: String) {
  launch(id: $id) {
    flight_number
    mission_name
    launch_year
...
/**
 * __useLauchProfileQuery__
 *
 * To run a query within a React component, call `useLauchProfileQuery` and pass it any options that fit your needs.
 * When your component renders, `useLauchProfileQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useLauchProfileQuery({
 *   variables: {
 *      id: // value for 'id'
 *   },
 * });
 */
export function useLauchProfileQuery(baseOptions?: Apollo.QueryHookOptions<LauchProfileQuery, LauchProfileQueryVariables>) {
        return Apollo.useQuery<LauchProfileQuery, LauchProfileQueryVariables>(LauchProfileDocument, baseOptions);
      }
export function useLauchProfileLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<LauchProfileQuery, LauchProfileQueryVariables>) {
          return Apollo.useLazyQuery<LauchProfileQuery, LauchProfileQueryVariables>(LauchProfileDocument, baseOptions);
        }
export type LauchProfileQueryHookResult = ReturnType<typeof useLauchProfileQuery>;
export type LauchProfileLazyQueryHookResult = ReturnType<typeof useLauchProfileLazyQuery>;
export type LauchProfileQueryResult = Apollo.QueryResult<LauchProfileQuery, LauchProfileQueryVariables>;